...
pythonでline notifyを利用できるライブラリ

https://github.com/broccolingual/python-line-notify

---

### 📌face-mask-tool-python
dlibの顔認識(face_recognitionライブラリ)を利用した顔マスク画像生成ツール

https://github.com/broccolingual/face-mask-tool-python

---

### 📌twitter-tweet-wordcloud
Twitter APIを利用したタイムライン/ユーザーのツイートの形態素解析&ワードクラウド作成ツール

https://github.com/broccolingual/twitter-tweet-wordcloud

---

### 📌mp4_to_m3u8
ffmpegを利用したmp4 to hls(ts+m3u8)変換スクリプト

https://github.com/broccolingual/twitter-tweet-wordcloud

---

### 📌Covid-19 Data Analysis (+GitHub Actions)
pythonを用いたコロナウイルスの都道府県別データ分析スクリプト
